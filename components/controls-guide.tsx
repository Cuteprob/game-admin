...
export function ControlsGuide() {
  return (
    <div className="w-[360px] bg-white/80 backdrop-blur-sm rounded-2xl border border-[#FFE5E5] p-4">
      <h3 className="font-heading text-primary text-lg mb-4">Shady Bears Controls Guide</h3>
      ...
      <p className="text-xs text-text-secondary mt-4 pt-4 border-t border-[#FFE5E5]">
        Tip: Master these controls to create amazing tracks in Shady Bears and challenge your friends!
      </p>
    </div>
  )
}
