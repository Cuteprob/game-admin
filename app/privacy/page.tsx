        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mt-8">
            ...
            <p className="text-text-secondary leading-relaxed mb-4">
              When you use Sprunki phase, we collect certain information to improve your gaming experience and our services:
            </p>
          ...
          <section className="mt-8">
            ...
            <p className="text-text-secondary leading-relaxed">
              Sprunki phase integrates with third-party services like Speedrun.com for leaderboards and track sharing. These services have their own privacy policies, and we encourage you to review them.
            </p>
          </section>
